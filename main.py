...
year, sex, Dx, Ex, age, observed_mu = func.load_excel(year = 2017, sex = "남자")
...
#--------------------
# TODO 여자 GM 적합 이상함
#scale_result = get_scale_data_from_file(filepath, year, sex, 
...
#func.run_test(year = year, sex = sex, df = df, trial = 1000, use_weights = True, notice = True,
#            center = 91, scale = 5, max_weight = 5, result_path = None,
#            opt_func = "differential_evolution")
#--------------------
...
try:
    ...
    best_result, best_logL, best_scale_params = func.find_best_scale(year = year, sex = sex, trial = 50, 
                        center_range = (89, 94, 1), scale_range = (1.0, 10.1, 0.5), max_weight_range = (2, 20, 1), n_runs = 100,
                        Dx = Dx, Ex = Ex, age = age, 
