...
Dx, Ex, age, observed_mu = func.load_excel(year = 2015, sex = "남자")
...
func.run_test(year = 2015, sex = '남자', df = df, trial = 100, use_weights = True, notice = True,
...
#                    center_range = (85, 96, 1), scale_range = (1.0, 10.1, 0.5), max_weight_range = (2, 20, 1), n_runs = 10,
#                    Dx = Dx, Ex = Ex, age = age)
#2001년 남자는 89, 1, 19
